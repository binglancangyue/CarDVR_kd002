        ...
        package com.bx.carDVR.bylym.adas.camera2video;
        ...
        public class Camera2VideoFragment extends Fragment
                implements View.OnClickListener, AdasServer.CameraDataProcessCallBack {
            ...
            public void onViewCreated(final View view, Bundle savedInstanceState) {
                ...
                adasDrawView = (AdasDrawView3) view.findViewById(R.id.adasDrawView);
...
//                }
            ...
            private AdasServer adasServer = null;
            ...
            private void initADAS() {
                ...
                adasServer = new AdasServer(getActivity());
                // }
                ...
                adasServer.setAdasServerRunMode(0);//设置室内模式 室内模式一定写成0，室外模式一定写成1
                ...
                //        );
                adasServer.startServer();//调用gps方法
                //        updateCarSpeed(0);
                ...
                Log.e(TAG, "mFrameChain:" + mFrameChain.toString());
            ...
            private final ImageReader.OnImageAvailableListener mOnImageAvailableListener = new ImageReader.OnImageAvailableListener() {
                ...
                public void onImageAvailable(ImageReader reader) {
                    ...
                    Log.e(TAG, "The onImageAvailable tims:" + (end - start));
                    start = end;
                    Log.e(TAG, "The onImageAvailable thread id: " + Thread.currentThread().getId());
            ...
            public void onProcessBack(LdwDetectInfo ldwDetectInfo, CdwDetectInfo cdwDetectInfo) {
                ...
                Log.e(TAG, "onProcessBack");
                if (cdwDetectInfo != null) {
                    Log.e(TAG, "" + cdwDetectInfo.toString());

                }
                adasDrawView.drawBitmap(ldwDetectInfo, cdwDetectInfo);
                //  Log.e(TAG,""+cdwDetectInfo.);
            }
